...
<!-- header-top -->
<div class="header-middle" style="background-color: #D9AFD9; background-image: linear-gradient(0deg, #D9AFD9 0%, #97D9E1 100%);">
                    ...
                    <ul>
                        <li class="@if(isset($menu) && $menu == 'dashboard') cp-user-active-page @endif">
                            <a href="{{route('userDashboard')}}" >
                                ...
                                <span class="cp-user-name" >Exchange</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'pocket') cp-user-active-page @endif">
                            <a href="{{route('myPocket')}}" >
                                ...
                                <span class="cp-user-name">Prices </span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'marketplace') cp-user-active-page @endif">
                            <a href="{{route('marketPlace')}}" >
                                ...
                                <span class="cp-user-name">Wallets</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'offer') cp-user-active-page @endif">
                            <a href="{{route('myOffer')}}" >
                                ...
                                <span class="cp-user-name">Promotions</span>
                            </a>
                        </li>
                        <li class=" @if(isset($menu) && $menu == 'trade') cp-user-active-page @endif">
                            <a href="{{route('myTradeList')}}" >
                                ...
                                <span class="cp-user-name">Activities</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'referral') cp-user-active-page @endif">
                            <a href="{{route('myReferral')}}" >
                                ...
                                <span class="cp-user-name">Notifications</span>
                            </a>
                        </li>
...
<!-- main wrapper -->
<div class="cp-user-main-wrapper" style="background-color: #D9AFD9; background-image: linear-gradient(0deg, #D9AFD9 0%, #97D9E1 100%);">
