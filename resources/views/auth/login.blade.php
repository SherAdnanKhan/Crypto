        ...
        <div class="user-form">
            <div class="right">
                ...
                <div class="form-group">
                    ...
                    <input type="email" value="{{old('email')}}" id="exampleInputEmail1" name="email" class="form-control" placeholder="{{__('Your email here')}}">
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="exampleInputPassword1" class="form-control form-control-password look-pass-a" placeholder="{{__('Your password here')}}">
                    @error('password')
                    <p class="invalid-feedback">{{ $message }} </p>
                    @enderror
